...
class _ProductDetailsScreenState extends State<ProductDetailsScreen> {
  ...
  //when we use this late variable fuctions doesnt work properly
                          ...
                          child: Swiper(
                            pagination: const SwiperPagination(
                                builder: SwiperPagination
                                    .dots), //we can use fraction instead of dots
                  ...
                  YellowButton(
                      label: context.read<Cart>().getItems.firstWhereOrNull(
                                    (product) =>
                                        product.documentId ==
                                        widget.proList['proid']) !=
                                null?'added to cart':'ADD TO CART',
                      onPressed: () {
                        //checking whether the item already in cart or not
                        ...
                        //if we remove this, other message handler works
...
class ProDetailHeader extends StatelessWidget {
  final String label;
  const ProDetailHeader({Key? key, required this.label}) : super(key: key);

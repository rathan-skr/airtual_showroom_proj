        ...
        child: Container(
          ...
          child:  RotatedBox(
            ...
            child: Row(
              ...
              children: [
                maincategName=='tables' ? const Text(' >> '): const Text(
                  ' << ',
                  style: TextStyle(
                    color: Colors.brown,
                    fontSize: 16, 
                    fontWeight: FontWeight.
                    w600,letterSpacing: 10
                    ),
                ),
                Text(
                ...
                maincategName=='beds' ? const Text(' << '): const Text(
                  ' >> ',
                  style: TextStyle(
                    color: Colors.brown,
                    fontSize: 16, 
...
class SubcategModel extends StatelessWidget {
  ...
  const SubcategModel({
    Key? key,required this.assetName,required this.mainCategName,required this.subCategName,required this.subcategLabel
  }) : super(key: key);
